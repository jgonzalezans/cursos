...
/**
 * Realiza un programa que dada una nota almacenada en una variable
 * nos diga si es un suspenso (1 a 4), aprobado (5 o 6), notable (7 u 8)
 * o sobresaliente (9 o 10). Para cualquier otro valor indicará no válida
 * 
